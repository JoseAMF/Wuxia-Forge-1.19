...
public class TestMissileProjectileEntity extends ThrowableItemProjectile {
    private int baseDamage = 9;

    // Three constructors, also make sure not to miss this line when altering it for copy-pasting
    public TestMissileProjectileEntity(EntityType<TestMissileProjectileEntity> type, Level world) {
        super(type, world);
        this.setNoGravity(true);
    }

    public TestMissileProjectileEntity(LivingEntity entity, Level world) {
        super(ModEntityTypes.TEST_MISSILE_PROJECTILE.get(), entity, world);
        this.setNoGravity(true);
    }

    public TestMissileProjectileEntity(double x, double y, double z, Level world) {
        super(ModEntityTypes.TEST_MISSILE_PROJECTILE.get(), x, y, z, world);
        this.setNoGravity(true);
    }
    ...
    protected Item getDefaultItem() {
        return ModItems.TEST_MISSILE_PROJECTILE.get().asItem();
    }
